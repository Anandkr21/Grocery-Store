...
cartRoute.get('/', authentication, fetchCartDetails); // Route to get all cart details for the authenticated user
cartRoute.post('/addtocart', authentication, addingToCart); // Route to add an item to the cart, accessible only to authenticated users
